...
<?php if (isset($_COOKIE['login'])) { ?>
    ...
    <div class="content-wrapper">
        ...
        <h2 class="text-dark font-weight-bold mb-4" style='text-align: left'>Контроль сроков подачи заявлений по
            графику</h2>
        ...
        <div>
                ...
                <div class="mb-1">
                    <div style=" display: flex;">
                        <div class="form-group mr-3 mb-0" style="display: inline-flex;">
                            <div id="period" style="font-size: 1rem; min-width: fit-content; line-height: 3rem;"
                                 class="mr-2">Отчетный период подачи заявления
                            </div>
                        ...
                        <div>
                            <div class="form-group mr-3 mb-0" style="display: inline-flex;">
                                <label for="inputDate"
                                       style="font-size: 1rem; min-width: fit-content; line-height: 3rem;" class="mr-2">с</label>
                                <input type="date" class="form-control" style="font-size: 1rem;" id="period_at">
                            </div>

                            <div class="form-group mb-0" style="display: inline-flex;">
                                <label for="inputDate"
                                       style="font-size: 1rem; min-width: fit-content; line-height: 3rem;" class="mr-2">по</label>
            ...
            <div class=" mb-3" style="display: flex;">
                <div>
                    <div class="form-group mr-3 mb-0" style="display: inline-flex;">
                        <label for="inputDate" style="font-size: 1rem; min-width: fit-content; line-height: 3rem;"
                               class="mr-2">Год подачи заявления по графику</label>
                        <input type="number" class="form-control" id='year_schedule' style="font-size: 1rem;" min="2024"
                               max="2099" step="1"/>
                    </div>

                    <div class="form-group mr-3 mb-0" style="display: inline-flex;">
                        <label for="inputDate" style="font-size: 1rem; min-width: fit-content; line-height: 3rem;"
                               class="mr-2">Количество дней на прохождение самоаккредитации</label>
