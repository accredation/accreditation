...
$query = "SELECT DISTINCT s.id_subvision, s.name ,  rc.id_department , rc.name as name_otdel, s.mark_accred_percent as percent , IFNULL(rc.mark_accred_percent,0) as dpercent, c.name_full , c.level
FROM applications a
