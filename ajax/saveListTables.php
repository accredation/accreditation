...
echo '<div class="card-header" id="heading' . $id_dep . '" style="justify-content: center; display: inline-grid; " onclick="newCollapseTable(this)">
    <button class="btn btn-link" data-toggle="collapse" data-target="#collapse' . $id_dep . '" aria-expanded="false" aria-controls="collapse' . $id_dep . '" style="text-decoration: none; color: black; font-size: 0.9rem;">
    ' . $department . '
    </button>
    </div>
    <div class="collapse" id="collapse' . $id_dep . '" aria-labelledby="heading' . $id_dep . '" data-parent="#accordion">
    <div class="card-body" id="cardBody' . $id_dep . '" style="padding: 0px;">
