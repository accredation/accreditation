...
$query = "
SELECT  tt.id_types_tables, tt.name as type_criteria, ltc.name as name_criteria , count(dep.id_list_tables_criteria) as crit_count
...
class Report{
    public /*$status , $date_send, */$id_types_tables, $type_criteria, $name_criteria, $crit_count;
}
