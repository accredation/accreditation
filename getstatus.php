...
$result = mysqli_query($con, "SELECT status, id_criteria FROM rating_criteria as rc WHERE rc.id_subvision = '$id_sub' and rc.value = 1 and rc.id_otvetstvennogo = '$id_user'");
