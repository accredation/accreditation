...
left outer join accreditation.applications a on sdo.id_uz=a.id_user and id_status<>8 and id_old_app is null
...
and (a.date_create_app is null or (a.date_create_app is not null and (a.date_create_app not between  sdo.schedule_date and DATE_ADD(sdo.schedule_date ,INTERVAL $count_day_proh DAY)  )))
