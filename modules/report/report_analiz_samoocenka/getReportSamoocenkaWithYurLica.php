...
SELECT st.name_status_report as name_status , app.date_send, sto.type_name as type_org, 
  ...
  app.mark_percent as app_ocenka
...
class Report{
    public $id_application, $status , $date_send, $type_org_name, $naim, $name_criteria, $id_types_tables,  $crit_count, $type_criteria, $crit_src, $app_ocenka;
