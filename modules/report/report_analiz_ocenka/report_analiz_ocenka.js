...
function preperaReport(){
    ...
    dataParametrs.criteriaIdStr =arrCriteriaId_report_analiz_ocenka.toString()
    dataParametrs.criteriaArr = arrCriteriaId_report_analiz_ocenka
...
function printReport2(data){
    ...
    tableToExcel(printMe,'Анализ результатов медицинской аккредитации', `Анализ_результатов_медицинской_аккредитации_${new Date().toLocaleDateString()}.xls`)
