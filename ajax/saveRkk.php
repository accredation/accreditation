...
if ($_POST['dateRegistr'] !== "" && $_POST['countlist'] !== "" && $_POST['tech_osn_rkk'] !== "" && $_POST['stat_rasp'] !== "" && $_POST['ucomp_rkk'] !== ""
    ...
    $formatted_date_admin_resh = date("Y-m-d", strtotime($date_admin_resh)) == "1970-01-01" ? "NULL" : "'".date("Y-m-d", strtotime($date_admin_resh))."'";
    $formatted_date_delo = date("Y-m-d", strtotime($date_delo)) == "1970-01-01" ? "NULL" : "'".date("Y-m-d", strtotime($date_delo))."'";
    $formatted_date_svidetelstvo = date("Y-m-d", strtotime($date_svidetelstvo)) == "1970-01-01" ? "NULL" : "'".date("Y-m-d", strtotime($date_svidetelstvo))."'";
